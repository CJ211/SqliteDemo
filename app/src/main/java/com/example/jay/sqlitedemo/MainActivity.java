package com.example.jay.sqlitedemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        empFirstName = new String[]{"Jay", "Nidhi", "Karan", "Shashank", "Saif","Sumer","Harsh"};
        empLastName = new String[]{"Shah","Shah","Vyas","Gandhi","Hans","Talati","Kshivsagar"};
        empAge = new String[]{"21","23","21","21","21","21","21"};
        empSex = new String[]{"Male","Female","Male","Male","Male","Male","Male"};
